...
figure
plot(t2(3:length(t2)-140),predictions_diff(3:length(predictions_diff)-140),'LineWidth',1.5)
xlabel('Time of Airbrake Deployment (s)','FontSize',16)
ylabel('Apogee Reduction (ft)','FontSize',16)
title("Aibrakes' Effect on Apogee for Varying Times of Deployment (Competition Launch 2022)",'FontSize',16)
